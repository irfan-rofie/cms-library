    ...
    <div class="col-md-12">
        <div class="portlet box red">
            <div class="portlet-title">
                <div class="caption"><i class="icon-table"></i>Data Admin</div>
            </div>
            <div class="portlet-body">
                <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                    ...
                    <tbody>
                        ...
                        $sql = mysql_query("SELECT * FROM mst_user");
...
//                            $a = date('mdYHis');
                            ...
                            <tr>
                                ...
                                <td align="center"><?php echo $row['nim_nik']; ?></td>
                                <td align="center">
                                        <a href="#portlet-config" id="<?php echo $row['id']; ?>" class="ubah" data-toggle="modal"><i class="icon-edit"></i>Edit</a>&nbsp;&nbsp;&nbsp;&nbsp;
                                        <a href="#portlet-config" id="<?php echo $row['id'] . "1"; ?>" class="detail" data-toggle="modal"><i class="icon-check"></i>Detail</a>&nbsp;&nbsp;&nbsp;&nbsp;
