    ...
    <div class="col-md-12">
        <div class="portlet box red">
            <div class="portlet-title">
                <div class="caption"><i class="icon-table"></i>Data Kategori Buku</div>
            </div>
            <div class="portlet-body">
                <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                    ...
                    <tbody>
                        ...
                        $sql = mysql_query("SELECT * FROM mst_kategori");
                        while ($row = mysql_fetch_array($sql)) {
                            ...
                            <tr>
                                ...
                                <td align="center">
                                        <a href="#portlet-config" id="<?php echo $row['id_kategori']; ?>" class="ubah" data-toggle="modal"><i class="icon-edit"></i>Edit</a>&nbsp;&nbsp;&nbsp;&nbsp;
                                        <a href="#portlet-config" id="<?php echo $row['id_kategori'] . "1"; ?>" class="detail" data-toggle="modal"><i class="icon-check"></i>Detail</a>&nbsp;&nbsp;&nbsp;&nbsp;
                                        <a class="#" href="#" onclick="yes('proses/pros_kat.php?aksi=hapus&id_kategori=<?php echo $row['id_kategori'] ?>')"><i class="icon-trash"></i>Delete</a>
                                </td>
                            </tr>
                            <?php } ?>
                    </tbody>
...
<script type="text/javascript">
    $(document).ready(function(e) {
        $('.ubah, .tambah, .detail').live("click", function() {
            var id = this.id;
            var url = "form/form_kategori.php";
